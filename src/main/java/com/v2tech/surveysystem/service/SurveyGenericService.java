...
public interface SurveyGenericService<Long,E> {
    ...
    public void save(E entity) throws SurveyGenericException;
    public E update(E entity) throws SurveyGenericException;
    public E saveOrUpdate(E entity) throws SurveyGenericException;
    
    /**
     * Will throw an exception if entity to be deleted is not found.
     * @param id
     * @throws SurveyGenericException
     */
